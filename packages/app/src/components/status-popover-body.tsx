...
export function StatusPopoverBody(props: { shown: Accessor<boolean> }) {
  ...
  const health = useServerHealth(servers, () => props.shown() && platform.platform === "desktop")
  ...
  const defaultTab = () => (platform.platform === "web" ? "mcp" : "servers")
  ...
  const pluginEmpty = createMemo(() => pluginEmptyMessage(language.t("dialog.plugins.empty"), ".cimi/cimicode"))
