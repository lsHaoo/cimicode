export const dict = {
  "session.header.more.restartService": "Uruchom usługę ponownie",
  "session.header.more.restartServiceConfirm": "Czy na pewno chcesz ponownie uruchomić usługę?",
  ...
  "command.session.archive": "Usuń sesję",
  ...
  "dialog.provider.cimi.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.cimi.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.cimigo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Cimi",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Cimi.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.CimiCodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Cimi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Cimi.",
  ...
  "dialog.plugins.empty": "Skonfiguruj wtyczki w folderze .cimi/cimicode",
  ...
  "dialog.server.description": "Przełącz serwer Cimi, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Cimi ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Cimi",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (Cimi.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Cimi zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Cimi",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Cimi na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Cimi ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Cimi.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Cimi",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Cimi.",
  ...
  "workspace.reset.archived.one": "1 sesja zostanie usunięta.",
  "workspace.reset.archived.many": "{{count}} sesji zostanie usuniętych.",
