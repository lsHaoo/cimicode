...
export const dict = {
  ...
  "dialog.provider.cimi.note": "使用 Cimi Zen 或 API 密钥连接",
  "dialog.provider.cimi.tagline": "可靠的优化模型",
  "dialog.provider.cimigo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Cimi 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Cimi 中使用 {{provider}} 模型。",
  ...
  "provider.connect.CimiCodeZen.line1": "Cimi Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.CimiCodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.CimiCodeZen.visit.prefix": "访问 ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Cimi 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Cimi 中使用 {{provider}} 模型。",
  ...
  "provider.custom.edit.title": "编辑自定义提供商",
  "provider.custom.action.editCurrent": "编辑当前自定义提供商",
  "provider.custom.field.providerID.label": "提供商 ID",
  "provider.custom.field.providerID.placeholder": "myprovider",
  "provider.custom.field.providerID.description": "使用小写字母、数字、连字符或下划线",
  "provider.custom.field.providerID.description.edit": "创建后无法修改提供商 ID。",
  ...
  "provider.custom.toast.updated.description": "{{provider}} 模型已按你的最新修改更新。",
  ...
  "dialog.plugins.empty": "在 .cimi/cimicode 文件夹下配置插件",
  ...
  "dialog.server.description": "切换此应用连接的 Cimi 服务器。",
  ...
  "toast.update.description": "Cimi 有新版本 ({{version}}) 可安装。",
  "toast.update.action.installRestart": "安装并重启",
  "toast.update.action.notYet": "稍后",
  "toast.reload.embed.title": "仅嵌入模式可用",
  "toast.reload.embed.description": "重启云主机仅在 iframe 嵌入的 Web 应用中可用。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Cimi 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (Cimi.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Cimi 暂不支持 MCP 认证。',
  ...
  "session.new.title": "你好，有什么新的工作安排吗？",
  ...
  "session.header.reload": "重启",
  "session.header.more.restartService": "重启云主机",
  "session.header.more.restartServiceConfirm": "确定要重启云主机吗？",
  ...
  "sidebar.gettingStarted.line1": "Cimi 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Cimi 服务器。",
  ...
  "settings.general.row.language.description": "更改 Cimi 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Cimi 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Cimi 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Cimi 的主题。",
  "settings.general.row.uiFont.title": "界面字体",
  "settings.general.row.uiFont.description": "自定义界面中使用的字体",
  ...
  "settings.general.row.showSessionProgressBar.description": "在任务运行时显示会话进度条",
  "settings.general.row.showFileTree.title": "显示文件树",
  "settings.general.row.showFileTree.description": "在会话视图中显示文件树",
  "settings.general.row.showNavigation.title": "显示导航",
  "settings.general.row.showNavigation.description": "在标题栏中显示导航控件",
  "settings.general.row.showSearch.title": "显示搜索",
  "settings.general.row.showSearch.description": "在标题栏中显示搜索操作",
  "settings.general.row.showTerminal.title": "显示终端",
  "settings.general.row.showTerminal.description": "在标题栏中显示终端切换入口",
  "settings.general.row.showStatus.title": "显示状态",
  "settings.general.row.showStatus.description": "在标题栏中显示状态指示器",
  ...
  "settings.updates.row.startup.description": "在 Cimi 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 CimiCode。",
  ...
  "workspace.reset.archived.none": "不会删除任何活跃会话。",
  "workspace.reset.archived.one": "将删除 1 个会话。",
  "workspace.reset.archived.many": "将删除 {{count}} 个会话。",
  ...
  "webFileTransfer.download.title": "文件系统",
  "webFileTransfer.download.tooltip": "查看工作空间文件",
