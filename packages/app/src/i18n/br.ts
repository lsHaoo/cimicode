export const dict = {
  "session.header.more.restartService": "Reiniciar serviço",
  "session.header.more.restartServiceConfirm": "Tem certeza de que deseja reiniciar o serviço?",
  ...
  "command.session.archive": "Excluir sessão",
  ...
  "dialog.provider.cimi.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.cimi.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.cimigo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Cimi",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Cimi.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.CimiCodeZen.visit.prefix": "Visite ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Cimi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Cimi.",
  ...
  "dialog.plugins.empty": "Configure plugins na pasta .cimi/cimicode",
  ...
  "dialog.server.description": "Trocar para qual servidor Cimi este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Cimi ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Cimi",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (Cimi.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Cimi ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cimi inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Cimi dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Cimi",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Cimi aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Cimi segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Cimi é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Cimi iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Cimi.",
  ...
  "workspace.reset.archived.none": "Nenhuma sessão ativa será excluída.",
  "workspace.reset.archived.one": "1 sessão será excluída.",
  "workspace.reset.archived.many": "{{count}} sessões serão excluídas.",
