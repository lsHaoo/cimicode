export const dict = {
  "session.header.more.restartService": "Redémarrer le service",
  "session.header.more.restartServiceConfirm": "Voulez-vous vraiment redémarrer le service ?",
  ...
  "command.session.archive": "Supprimer la session",
  ...
  "dialog.provider.cimi.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.cimi.tagline": "Modèles optimisés et fiables",
  "dialog.provider.cimigo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Cimi",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Cimi.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.CimiCodeZen.visit.prefix": "Visitez ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Cimi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Cimi.",
  ...
  "dialog.plugins.empty": "Configurez les plugins dans le dossier .cimi/cimicode",
  ...
  "dialog.server.description": "Changez le serveur Cimi auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Cimi ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Cimi",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (Cimi.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Cimi ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Cimi inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Cimi dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Cimi",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Cimi sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Cimi suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Cimi.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Cimi",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Cimi.",
  ...
  "workspace.reset.archived.none": "Aucune session active ne sera supprimée.",
  "workspace.reset.archived.one": "1 session sera supprimée.",
  "workspace.reset.archived.many": "{{count}} sessions seront supprimées.",
