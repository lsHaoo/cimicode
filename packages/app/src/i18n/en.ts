export const dict = {
  ...
  "command.session.archive": "Delete session",
  ...
  "command.session.export.description": "Download this session as a Markdown file",
  ...
  "dialog.provider.cimi.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.cimi.tagline": "Reliable optimized models",
  "dialog.provider.cimigo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Cimi",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Cimi.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.CimiCodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.CimiCodeZen.visit.prefix": "Visit ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Cimi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Cimi.",
  ...
  "provider.custom.edit.title": "Edit custom provider",
  "provider.custom.action.editCurrent": "Edit current custom provider",
  ...
  "provider.custom.field.providerID.description.edit": "Provider ID can't be changed after creation.",
  ...
  "provider.custom.toast.updated.description": "{{provider}} models are ready with your latest changes.",
  ...
  "dialog.plugins.empty": "Configure plugins in the .cimi/cimicode folder",
  ...
  "dialog.server.description": "Switch which Cimi server this app connects to.",
  ...
  "error.chain.checkConfig": "Check your config (Cimi.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Cimi does not support MCP authentication yet.',
  ...
  "session.files.refresh": "Refresh files",
  ...
  "session.new.title": "Hello, what would you like to work on today?",
  ...
  "session.header.reload": "Restart",
  "session.header.more.restartService": "Restart service",
  "session.header.more.restartServiceConfirm": "Are you sure you want to restart the service?",
  ...
  "sidebar.gettingStarted.line1": "Cimi includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Cimi server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Cimi",
  ...
  "settings.general.row.appearance.description": "Customise how Cimi looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Cimi follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Cimi is themed.",
  ...
  "settings.general.row.showSessionProgressBar.description": "Display the session progress bar while tasks are running",
  "settings.general.row.showFileTree.title": "Show file tree",
  "settings.general.row.showFileTree.description": "Display the file tree in the session view",
  "settings.general.row.showNavigation.title": "Show navigation",
  "settings.general.row.showNavigation.description": "Display the navigation controls in the title bar",
  "settings.general.row.showSearch.title": "Show search",
  "settings.general.row.showSearch.description": "Display the search action in the title bar",
  "settings.general.row.showTerminal.title": "Show terminal",
  "settings.general.row.showTerminal.description": "Display the terminal toggle in the title bar",
  "settings.general.row.showStatus.title": "Show status",
  "settings.general.row.showStatus.description": "Display the status indicator in the title bar",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Cimi launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Cimi.",
  ...
  "workspace.reset.archived.none": "No active sessions will be deleted.",
  "workspace.reset.archived.one": "1 session will be deleted.",
  "workspace.reset.archived.many": "{{count}} sessions will be deleted.",
  ...
  "webFileTransfer.download.title": "File System",
  "webFileTransfer.download.tooltip": "View workspace files",
