...
export const dict = {
  "session.header.more.restartService": "重啟雲主機",
  "session.header.more.restartServiceConfirm": "確定要重啟雲主機嗎？",
  ...
  "command.session.archive": "刪除工作階段",
  ...
  "command.session.export": "匯出會話",
  "command.session.export.description": "將此工作階段下載為 Markdown 檔案",
  ...
  "dialog.provider.cimi.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.cimi.tagline": "可靠的優化模型",
  "dialog.provider.cimigo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Cimi 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Cimi 中使用 {{provider}} 模型。",
  ...
  "provider.connect.CimiCodeZen.line1": "Cimi Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.CimiCodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.CimiCodeZen.visit.prefix": "造訪 ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Cimi 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Cimi 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 .cimi/cimicode 資料夾下設定外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Cimi 伺服器。",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (Cimi.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Cimi 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Cimi 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Cimi 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Cimi 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Cimi 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Cimi 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Cimi 的主題。",
  "settings.general.row.uiFont.title": "介面字型",
  "settings.general.row.uiFont.description": "自訂介面中使用的字型",
  "settings.general.row.font.title": "字型",
  "settings.general.row.font.description": "自訂程式碼區塊使用的等寬字型",
  "settings.general.row.terminalFont.title": "終端字型",
  "settings.general.row.terminalFont.description": "自訂終端中使用的字型",
  ...
  "settings.general.row.showSessionProgressBar.description": "在任務執行時顯示工作階段進度列",
  "settings.general.row.showFileTree.title": "顯示檔案樹",
  "settings.general.row.showFileTree.description": "在工作階段檢視中顯示檔案樹",
  "settings.general.row.showNavigation.title": "顯示導覽",
  "settings.general.row.showNavigation.description": "在標題列中顯示導覽控制項",
  "settings.general.row.showSearch.title": "顯示搜尋",
  "settings.general.row.showSearch.description": "在標題列中顯示搜尋操作",
  "settings.general.row.showTerminal.title": "顯示終端機",
  "settings.general.row.showTerminal.description": "在標題列中顯示終端機切換入口",
  "settings.general.row.showStatus.title": "顯示狀態",
  "settings.general.row.showStatus.description": "在標題列中顯示狀態指示器",
  ...
  "settings.updates.row.startup.description": "在 Cimi 啟動時自動檢查更新",
  ...
  "workspace.reset.archived.none": "不會刪除任何作用中工作階段。",
  "workspace.reset.archived.one": "將刪除 1 個工作階段。",
  "workspace.reset.archived.many": "將刪除 {{count}} 個工作階段。",
