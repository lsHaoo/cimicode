...
export const dict = {
  "session.header.more.restartService": "Dienst neu starten",
  "session.header.more.restartServiceConfirm": "Möchtest du den Dienst wirklich neu starten?",
  ...
  "command.session.archive": "Sitzung löschen",
  ...
  "dialog.provider.cimi.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.cimi.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.cimigo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Cimi",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cimi zu nutzen.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.CimiCodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Cimi zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cimi zu nutzen.",
  ...
  "dialog.plugins.empty": "Plugins im Ordner .cimi/cimicode konfigurieren",
  ...
  "dialog.server.description": "Wechseln Sie den Cimi-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Cimi ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Cimi-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (Cimi.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Cimi unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Cimi enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Cimi-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Cimi ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Cimi auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob Cimi dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Cimi anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Cimi automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Cimi.",
  ...
  "workspace.reset.archived.none": "Keine aktiven Sitzungen werden gelöscht.",
  "workspace.reset.archived.one": "1 Sitzung wird gelöscht.",
  "workspace.reset.archived.many": "{{count}} Sitzungen werden gelöscht.",
