export const dict = {
  "session.header.more.restartService": "Genstart tjeneste",
  "session.header.more.restartServiceConfirm": "Er du sikker på, at du vil genstarte tjenesten?",
  ...
  "command.session.archive": "Slet session",
  ...
  "dialog.provider.cimi.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.cimi.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.cimigo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Cimi",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Cimi.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.CimiCodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.CimiCodeZen.visit.prefix": "Besøg ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Cimi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Cimi.",
  ...
  "dialog.server.description": "Skift hvilken Cimi-server denne app forbinder til.",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (Cimi.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Cimi understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Cimi inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Cimi-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Cimi",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Cimi ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Cimi følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Cimi er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Cimi starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Cimi.",
  ...
  "workspace.reset.archived.none": "Ingen aktive sessioner vil blive slettet.",
  "workspace.reset.archived.one": "1 session vil blive slettet.",
  "workspace.reset.archived.many": "{{count}} sessioner vil blive slettet.",
