export const dict = {
  "session.header.more.restartService": "サービスを再起動",
  "session.header.more.restartServiceConfirm": "サービスを再起動してもよろしいですか？",
  ...
  "command.session.archive": "セッションを削除",
  ...
  "dialog.provider.cimi.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.cimi.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.cimigo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "CimiCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、CimiCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.CimiCodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.CimiCodeZen.visit.prefix": " ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCimiCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、CimiCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": ".cimi/cimicode フォルダーでプラグインを設定",
  ...
  "dialog.server.description": "このアプリが接続するCimiCodeサーバーを切り替えます。",
  ...
  "toast.update.description": "CimiCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCimiCodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (Cimi.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CimiCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "CimiCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCimiCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "CimiCodeの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのCimiCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "CimiCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "CimiCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Cimi の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Cimi は最新バージョンです。",
  ...
  "workspace.reset.archived.none": "アクティブなセッションは削除されません。",
  "workspace.reset.archived.one": "1つのセッションが削除されます。",
  "workspace.reset.archived.many": "{{count}}個のセッションが削除されます。",
