...
export const dict = {
  "session.header.more.restartService": "Start tjenesten på nytt",
  "session.header.more.restartServiceConfirm": "Er du sikker på at du vil starte tjenesten på nytt?",
  ...
  "command.session.archive": "Slett sesjon",
  ...
  "dialog.provider.cimi.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.cimi.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.cimigo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Cimi",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Cimi.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.CimiCodeZen.visit.prefix": "Besøk ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Cimi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Cimi.",
  ...
  "dialog.plugins.empty": "Konfigurer plugins i mappen .cimi/cimicode",
  ...
  "dialog.server.description": "Bytt hvilken Cimi-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Cimi ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Cimi-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (Cimi.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Cimi ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Cimi inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Cimi-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Cimi",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Cimi ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Cimi skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Cimi er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Cimi starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Cimi.",
