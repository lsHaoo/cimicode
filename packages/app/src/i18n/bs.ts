export const dict = {
  "session.header.more.restartService": "Ponovo pokreni servis",
  "session.header.more.restartServiceConfirm": "Da li ste sigurni da želite ponovo pokrenuti servis?",
  ...
  "command.session.archive": "Obriši sesiju",
  ...
  "dialog.provider.cimi.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.cimi.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.cimigo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Cimi",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Cimi-u.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.CimiCodeZen.visit.prefix": "Posjeti ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Cimi-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Cimi-u.",
  ...
  "dialog.plugins.empty": "Konfigurišite plugine u folderu .cimi/cimicode",
  ...
  "dialog.server.description": "Promijeni na koji se Cimi server ova aplikacija povezuje.",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (Cimi.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Cimi još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Cimi uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Cimi server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Cimi-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Cimi izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Cimi prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Cimi-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Cimi pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Cimi-a.",
  ...
  "workspace.reset.archived.none": "Nijedna aktivna sesija neće biti obrisana.",
  "workspace.reset.archived.one": "1 sesija će biti obrisana.",
