export const dict = {
  "session.header.more.restartService": "Перезапустить сервис",
  "session.header.more.restartServiceConfirm": "Вы уверены, что хотите перезапустить сервис?",
  ...
  "command.session.archive": "Удалить сессию",
  ...
  "dialog.provider.cimi.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.cimi.tagline": "Надежные оптимизированные модели",
  "dialog.provider.cimigo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Cimi",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Cimi.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.CimiCodeZen.visit.prefix": "Посетите ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Cimi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Cimi.",
  ...
  "dialog.plugins.empty": "Настройте плагины в папке .cimi/cimicode",
  ...
  "dialog.server.description": "Переключите сервер Cimi к которому подключается приложение.",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (Cimi.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Cimi пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Cimi включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Cimi внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Cimi",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Cimi выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Cimi системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Cimi.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Cimi",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Cimi.",
  ...
  "workspace.reset.archived.none": "Активные сессии не будут удалены.",
  "workspace.reset.archived.one": "1 сессия будет удалена.",
  "workspace.reset.archived.many": "{{count}} сессий будет удалено.",
