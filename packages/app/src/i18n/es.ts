export const dict = {
  "session.header.more.restartService": "Reiniciar servicio",
  "session.header.more.restartServiceConfirm": "¿Seguro que quieres reiniciar el servicio?",
  ...
  "command.session.archive": "Eliminar sesión",
  ...
  "command.session.export.description": "Descargar esta sesión como archivo Markdown",
  ...
  "dialog.provider.cimi.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.cimi.tagline": "Modelos optimizados y fiables",
  "dialog.provider.cimigo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Cimi",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Cimi.",
  ...
  "provider.connect.CimiCodeZen.line1":
    "Cimi Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.CimiCodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.CimiCodeZen.visit.prefix": "Visita ",
  "provider.connect.CimiCodeZen.visit.link": "Cimi.ai/zen",
  "provider.connect.CimiCodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Cimi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Cimi.",
  ...
  "dialog.plugins.empty": "Configura los plugins en la carpeta .cimi/cimicode",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Cimi se conecta esta app.",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (Cimi.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Cimi no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Cimi incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Cimi dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Cimi",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Cimi en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Cimi sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Cimi.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Cimi",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Cimi.",
  ...
  "workspace.reset.archived.none": "No se eliminarán sesiones activas.",
