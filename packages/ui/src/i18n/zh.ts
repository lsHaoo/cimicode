...
export const dict = {
  ...
  "ui.sessionReview.title.git": "未提交更改",
  ...
  "ui.htmlPreview.mode.source": "源码",
  "ui.htmlPreview.mode.preview": "预览",
  "ui.htmlPreview.restore": "恢复预览",
  "ui.htmlPreview.openInBrowser": "浏览器打开",
