...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "Cimi Documentation", click: () => shell.openExternal("https://cimicode.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/cimicode") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/anomalyco/cimicode/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/anomalyco/cimicode/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
