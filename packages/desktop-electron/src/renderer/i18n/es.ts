export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Cimi",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Cimi. ¿Quieres instalarla y reiniciar?",
